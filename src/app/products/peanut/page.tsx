...
export const metadata: Metadata = { title: "Peanut Export" };

export default function PeanutPage() {
  const product = getProductBySlug("peanut")!;
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16">
          <div>
            <div className="relative h-64 mb-8 overflow-hidden border border-vvj-border">
              <Image
                src={product.image}
                alt="High-grade peanuts prepared for export"
                fill
          ...
          <div className="p-8 border border-emerald-border bg-surface h-fit">
            ...
            <p className="text-sm text-vvj-muted leading-relaxed mb-6">
              ...
              processing form — we&apos;ll respond within 24 hours.
            </p>
            <a
              href="/contact"
