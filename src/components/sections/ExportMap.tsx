        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 items-start">
          ...
          >
            ...
            <div className="absolute top-4 right-4 flex items-center gap-4" style={{ zIndex: 2 }}>
              ...
              <div className="flex items-center gap-2">
                <div style={{ width: "12px", height: "12px", background: "rgba(201,168,76,0.8)", borderRadius: "50%", border: "2px solid var(--emerald-mid)" }} />
            ...
            >
              ...
              <path d="M75 55 L185 48 L210 88 L205 150 L185 195 L155 215 L120 205 L85 170 L62 128 Z"
                fill="rgba(201,168,76,0.07)" stroke="rgba(201,168,76,0.2)" strokeWidth="0.8" />
              {/* Greenland */}
              <path d="M190 25 L240 20 L255 45 L235 65 L195 60 Z"
                fill="rgba(201,168,76,0.05)" stroke="rgba(201,168,76,0.15)" strokeWidth="0.8" />
              {/* South America */}
              ...
              <path d="M462 28 L790 18 L808 78 L670 95 L560 90 L468 78 Z"
                fill="rgba(201,168,76,0.06)" stroke="rgba(201,168,76,0.15)" strokeWidth="0.8" />
              {/* Middle East — HIGHLIGHTED (export dest) */}
              <path d="M490 115 L568 108 L590 148 L578 195 L532 205 L498 182 L480 148 Z"
                fill="rgba(201,168,76,0.2)" stroke="rgba(201,168,76,0.5)" strokeWidth="1" />
              {/* India — SOURCE (bright) */}
              <path d="M592 128 L648 118 L672 152 L684 202 L660 248 L628 270 L598 238 L578 195 L582 158 Z"
                fill="rgba(201,168,76,0.45)" stroke="rgba(201,168,76,0.9)" strokeWidth="1.5" />
              {/* India label */}
              <text x="630" y="175" textAnchor="middle" fill="rgba(201,168,76,0.9)" fontSize="9"
                fontFamily="system-ui" letterSpacing="2">INDIA</text>
              {/* India center dot */}
              <circle cx="630" cy="192" r="5" fill="var(--emerald-mid)" />
              {/* India pulse ring */}
              <circle cx="630" cy="192" r="12" fill="none" stroke="rgba(201,168,76,0.3)" strokeWidth="1">
              ...
              <path d="M688 168 L762 162 L782 200 L772 240 L740 252 L710 232 L692 200 Z"
                fill="rgba(201,168,76,0.18)" stroke="rgba(201,168,76,0.4)" strokeWidth="1" />
              {/* Sri Lanka */}
              <ellipse cx="648" cy="278" rx="9" ry="11"
                fill="rgba(201,168,76,0.35)" stroke="rgba(201,168,76,0.7)" strokeWidth="1" />
              {/* Bangladesh */}
              <ellipse cx="692" cy="178" rx="10" ry="9"
                fill="rgba(201,168,76,0.3)" stroke="rgba(201,168,76,0.6)" strokeWidth="1" />
              {/* Australia */}
              ...
              <ellipse cx="488" cy="245" rx="7" ry="7"
                fill="rgba(201,168,76,0.25)" stroke="rgba(201,168,76,0.5)" strokeWidth="1" />

              {/* ── Export route lines from India ── */}
              {/* India → UAE */}
              <line x1="630" y1="192" x2="535" y2="152"
                stroke="rgba(201,168,76,0.4)" strokeWidth="1" strokeDasharray="5 4" />
              {/* India → Sri Lanka */}
              ...
              <line x1="630" y1="192" x2="692" y2="180"
                stroke="rgba(201,168,76,0.35)" strokeWidth="1" strokeDasharray="4 4" />
              {/* India → Djibouti */}
              <line x1="630" y1="192" x2="490" y2="244"
                stroke="rgba(201,168,76,0.3)" strokeWidth="1" strokeDasharray="5 5" />
              {/* India → Australia */}
              <line x1="630" y1="192" x2="775" y2="355"
                stroke="rgba(201,168,76,0.25)" strokeWidth="1" strokeDasharray="6 5" />
