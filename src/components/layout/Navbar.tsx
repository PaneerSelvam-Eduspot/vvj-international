    ...
    <>
      <nav
        className={cn(
          ...
          scrolled ? "glass-nav h-[88px]" : "bg-transparent h-[100px]"
        )}
      ...
      >
        <div className="w-full px-[5%] h-full flex items-center justify-between">
          ...
          {/* ── Logo ── */}
          <Link href="/" className="flex items-center gap-3 leading-none group z-10">
            <Image
              src="/vvj-logo.png"
              alt="VVJ International logo"
              width={140}
              height={140}
